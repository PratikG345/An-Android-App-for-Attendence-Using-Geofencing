...
import com.example.student_attendance_app.Verify
...
//        if(currentUser != null) {
//            startActivity(Intent(applicationContext, Biofingureprintverification::class.java))
//            finish()
//        }
...
//                startActivity(Intent(applicationContext, Biofingureprintverification::class.java))
//                finish()
                Toast.makeText(applicationContext,"Otp Verification",Toast.LENGTH_LONG).show()
            }
